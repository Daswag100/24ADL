    ...
    >
      ...
      <div className="max-w-7xl w-full mx-auto px-6 lg:px-10 z-10 flex flex-col justify-center relative">
        <div className="max-w-3xl flex flex-col text-left">
          ...
          {/* Headline H1 */}
          <h1
            className={`font-syne font-extrabold text-5xl sm:text-6xl lg:text-[80px] text-white tracking-tight leading-[1.05] mb-6 transform transition-all duration-700 delay-200 ${
              isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-4'
            }`}
          >
