    ...
    <section id="careers" className="py-14 md:py-24 bg-[#FAFAF9] overflow-hidden">
      ...
      >
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <motion.h2
            variants={itemVariants}
            className="font-syne font-bold text-4xl lg:text-5xl text-brand-black tracking-tight mb-4"
          >
            Build Your Future With Us
          </motion.h2>
          <motion.p
            variants={itemVariants}
            className="font-dmsans text-base sm:text-lg text-brand-gray-mid leading-relaxed"
          >
        ...
        >
          ...
          <h3 className="font-syne font-bold text-2xl sm:text-3xl text-brand-black tracking-tight mb-6">
          ...
          <p className="font-dmsans text-sm text-brand-gray-mid/80 leading-relaxed mb-8 border-t border-gray-100 pt-6">
        ...
        <div className="max-w-5xl mx-auto">
          <motion.h4
            variants={itemVariants}
            className="font-syne font-bold text-2xl text-brand-black text-center mb-12"
          >
          ...
          >
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                className="bg-white border border-gray-200/80 rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-all duration-300 flex flex-col items-center"
              >
                <div className="w-12 h-12 bg-brand-purple-light rounded-lg flex items-center justify-center mb-5 shrink-0">
                  {benefit.icon}
                </div>
                <h5 className="font-syne font-bold text-lg text-brand-black mb-3">
                  {benefit.title}
                </h5>
                <p className="font-dmsans text-sm text-brand-gray-mid leading-relaxed">
                  {benefit.description}
                </p>
              </motion.div>
            ))}
