...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#050505] text-white border-t border-white/8 pt-16 pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 pb-12 border-b border-white/5">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="flex items-center gap-3 mt-2">
              <a
                href="#"
                className="w-10 h-10 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-white/60 hover:text-white hover:border-[#E1306C] hover:bg-[#E1306C]/10 transition-all duration-300"
              ...
              <a
                href="#"
                className="w-10 h-10 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-white/60 hover:text-white hover:border-[#25D366] hover:bg-[#25D366]/10 transition-all duration-300"
